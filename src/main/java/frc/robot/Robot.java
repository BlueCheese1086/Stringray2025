...
public class Robot extends TimedRobot {
    ...
    public Robot() {
        TurboLogger2.log("/TempStruct", new Rotation2d(2 * Math.PI));

        System.out.println(TurboLogger2.getStruct("/TempStruct").getClass().getName());
        ...
        // TurboLogger.log("/Adjustables/AutoAlign/X/kP", DriveConstants.kPXDefault, "X_kP");
        // TurboLogger.log("/Adjustables/AutoAlign/X/kI", DriveConstants.kIXDefault, "X_kI");
        // TurboLogger.log("/Adjustables/AutoAlign/X/kD", DriveConstants.kDXDefault, "X_kD");

        // TurboLogger.log("/Adjustables/AutoAlign/Y/kP", DriveConstants.kPYDefault, "Y_kP");
        // TurboLogger.log("/Adjustables/AutoAlign/Y/kI", DriveConstants.kIYDefault, "Y_kI");
        // TurboLogger.log("/Adjustables/AutoAlign/Y/kD", DriveConstants.kDYDefault, "Y_kD");

        // TurboLogger.log("/Adjustables/AutoAlign/Theta/kP", DriveConstants.kPThetaDefault, "Theta_kP");
        // TurboLogger.log("/Adjustables/AutoAlign/Theta/kI", DriveConstants.kIThetaDefault, "Theta_kI");
        // TurboLogger.log("/Adjustables/AutoAlign/Theta/kD", DriveConstants.kDThetaDefault, "Theta_kD");
