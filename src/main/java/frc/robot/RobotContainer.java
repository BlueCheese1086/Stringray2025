...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        if (Robot.isReal()) {
            ...
            drivetrain = new Drivetrain(gyro, new ModuleIOTalonFX(0), new ModuleIOTalonFX(1), new ModuleIOTalonFX(2), new ModuleIOTalonFX(3));
            ...
            drivetrain = new Drivetrain(gyro, new ModuleIOSim(0), new ModuleIOSim(1), new ModuleIOSim(2), new ModuleIOSim(3));
