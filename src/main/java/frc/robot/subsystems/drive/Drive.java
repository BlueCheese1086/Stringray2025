...
public class Drive extends SubsystemBase {
  ...
  private ProfiledPIDController trajHeading =
      new ProfiledPIDController(AdjustableValues.getNumber("rotkP"), 0.0, 0.0, new Constraints(3.5, 3.5));
  ...
  public void periodic() {
    ...
    for (int i = 0; i < sampleCount; i++) {
      ...
      if (AdjustableValues.hasChanged("xkP")) autoXPID.setP(AdjustableValues.getNumber("xkP"));
      if (AdjustableValues.hasChanged("ykP")) autoXPID.setP(AdjustableValues.getNumber("ykP"));
      if (AdjustableValues.hasChanged("rotkP")) autoXPID.setP(AdjustableValues.getNumber("rotkP"));
    }

    // Update gyro alert
    // gyroDisconnectedAlert.set(!gyroInputs.connected && Robot.isReal() != Robot.isSimulation());
  }
