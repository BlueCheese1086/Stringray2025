...
public class SetHopperPercent extends Command {
    ...
    /**
     * Creates a new SetHopperPercent command.
     ...
     */
    public SetHopperPercent(Hopper hopper, Supplier<Double> percentSupplier) {
        this.hopper = hopper;
    ...
    @Override
    public void execute() {
        hopper.setPercent(percentSupplier.get() * HopperConstants.maxPercent);
    }
